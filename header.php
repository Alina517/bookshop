							...
							if ($isLogin){?>
								<form action="actions.php" method="POST">
									<div class="register row">
											<?php 
											if ($isAdmin) {?>
												<a class="btn btn-dark mr-2" type="submit" href="admin.php">Администрирование</a>
											<?php }
											else { ?>
			...
			<ul class="nav nav-pills">
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="catalog_belletristic.php">Художественная литература</a>					
						<a class="dropdown-item" href="catalog_art.php">Искусство</a>						
						<a class="dropdown-item" href="catalog_education.php">Образование</a>						
						<a class="dropdown-item" href="catalog_for_children.php">Книги для детей</a>
						<div class="dropdown-divider"></div>						
						<a class="dropdown-item" href="catalog_over.php">Другое</a>
					</div>
				</li>
				<li class="nav-item">
